  ...
  return (
    <>
      ...
      <Drawer title="Developer" onClose={onClose} open={open.open}>
        <p><span style={{color: 'gray'}}>Name:</span> {open.data?.first_name} {open.data?.last_name}</p>
        <p><span style={{color: 'gray'}}>Username:</span> {open.data?.username}</p>
        <p><span style={{color: 'gray'}}>Email:</span> {open.data?.email}</p>
      </Drawer>
    </>
  );
};
